...
export const TYPE_LIBRARY = {
    ...
    OJBK: {
        ...
        cn: `无所谓人`,
        intro: `我说随便，是真的随便。`,
        desc: `让我们直面这个词的粗犷本质：OJBK。这已经不是一种人格，而是一种统治哲学！一种凌驾于世俗纷扰之上的、帝王般的慵懒与恩准！当一个凡人面临”中午吃米饭还是面条”的世纪抉择时，他们的大脑在激烈地燃烧卡路里。而OJBK人格，会用一种批阅奏章般的淡然，轻飘飘地吐出两个字：”都行”。这不是没主见，这是在告诉你：”尔等凡俗的选择，于朕而言，皆为蝼蚁。”OJBK可能被外人评价为”随和的好人”，他们的核心理念是”无为而治”。为什么不争执？因为跟草履虫辩论宇宙的未来毫无意义。为什么不较真？因为帝王不会在意脚下的尘埃是该往左飘还是往右飘。所以，当一个OJBK人格对你的疯狂想法点头说”OK”时，不要以为他只是在敷衍你。他是在用他那历经沧桑、看透一切的王者之心，对你的想法进行了最终的、至高无上的盖章认证。至于那个”G8”是什么意思？嘘……那是因为为了合规，不过作者觉得无所谓了，无所谓人，你听懂了吗？`
    },
    MALO: {
        code: `MALO`,
        cn: `吗喽`,
...
// 8. 图片映射表 (过滤掉 Base64 变量 v，使用本地图片方案，已处理作者合规改名)
export const TYPE_IMAGES = {
    ...
    "ZZZZ": "./image/ZZZZ.png",
    "GOGO": "./image/GOGO.png",
    "FUCK": "./image/FUCK.png", // 映射旧版草者图片
    "CTRL": "./image/CTRL.png",
    "HHHH": "./image/HHHH.png",
    "SEXY": "./image/SEXY.png",
    "OJBK": "./image/OJBK.png", // 映射旧版无所谓人图片
